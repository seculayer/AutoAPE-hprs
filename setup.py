...
from hprs.common.tools.VersionManagement import VersionManagement
...
FILE_LIST += FileUtils.read_dir(
    directory=FileUtils.get_realpath(file=__file__) + "/hprs/resources/conf", ext=".xml"
)
FILE_LIST += FileUtils.read_dir(
    directory=FileUtils.get_realpath(file=__file__) + "/hprs/resources", ext=".json"
)
print(FILE_LIST)
print("-------------------------------------------------------------------------------")
######################################################################################
