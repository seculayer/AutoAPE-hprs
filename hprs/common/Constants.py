...
from hprs.common.utils.ConfUtils import ConfUtils
...
class Constants(metaclass=Singleton):
    ...
    _CONFIG = ConfUtils.load(filename=os.getcwd() + "/conf/hprs-conf.xml")
    ...
    LOG_NAME = _CONFIG.get("log_name", "HyperParameterRecommender")
