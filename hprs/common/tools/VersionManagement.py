...
from hprs.common.exceptions.VersionManagementError import VersionManagementError
...
class VersionManagement(object):
    def __init__(self, app_path=None):
        try:
            ...
            self.MODULE_NM = _VER_INFO.get("module", "hprs")
    ...
    @staticmethod
    def generate(version="1.0.0", app_path=None, module_nm="hprs"):
        if app_path is None:
            app_path = os.getcwd()
